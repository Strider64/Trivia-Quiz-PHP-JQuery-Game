...
<div class="container mainContent">
    <div class="highscoresShadow">
        ...
        <div id="tableBox">
            <!--- Highscores Table -->
            <div id="cms"></div>
            <a  class="exitBtn" href="index.php">trivia game</a>
        </div>
        ...
        <div class="mainGame">
            <div class="shadow">
                <div class="startBox">
                    ...
                    <?php } else { ?>
                        <div class="logout">
                            <p class="logoutTxt">Player : <?php echo $user->username; ?><span><a class="logoutLink" href="logout.php">logout</a></span></p>
                        </div>
                    <?php } ?>
                    <form id="highscores" action="index.php" method="post">
                    ...
                    <a class="startButton" href="index.php">Start</a>
