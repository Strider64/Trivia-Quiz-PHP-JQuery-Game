...
class Verification {
    ...
    public function __construct(array $data) {
        ...
        if (filter_input(INPUT_SERVER, 'SERVER_NAME', FILTER_SANITIZE_URL) == "localhost") {
            /* Local Server */
            $this->message = 'Thank you for registering at J.R. Pepp Website and to gain full access to the forums simply click or copy the following link:<br><br> <a style="text-decoration:none;color=darkblue" href="http://localhost:8000/confirm.php?confirm_number=' . $this->confirmation_code . '">http://localhost:8000/confirm.php?confirm_number=' . $this->confirmation_code . '</a>';
        } else {
            /* Web Server */
            $this->message = 'Thank you for registering at J.R. Pepp Website and to gain full access to the forums simply click or copy the following link:<br><br> <a style="text-decoration:none;color=darkblue" href="https://www.pepster.com/confirm.php?confirm_number=' . $this->confirmation_code . '">https://www.pepster.com/confirm.php?confirm_number=' . $this->confirmation_code . '</a>';
        }
    }
    ...
    public function sendEmailVerification() {
        ...
        $this->mail->Body = '<img src="https://www.pepster.com/lib/images/img-logo.png"><p style="color:green;font-family:sans-serif;">' . $this->message . '</p>';
